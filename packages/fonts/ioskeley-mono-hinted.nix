...
pkgs.stdenvNoCC.mkDerivation {
  pname = "ioskeley-mono-hinted";
  version = "1.0";

  src = ../../assets/fonts/IoskeleyMono-TTF-Hinted.zip;
  ...
  #     nerd-font-patcher --mono --complete --outputdir $out/share/fonts/truetype/ioskeley-mono-nerd/ $f
  #   done
  # '';
}
